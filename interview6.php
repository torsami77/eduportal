...
<input type="button" value="<<< Back" onclick="location.href='interview5.php'" />
</div>
<h2 style="color:blue; float:left;">INTERVIEW MODE</h2>
<div style="float:left;">
<input type="button" value="View candidate's next referee" onclick="location.href='interview7.php'" />
</div>
</fieldset>
