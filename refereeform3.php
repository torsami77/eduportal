...
<textarea cols="20" rows="7" name="42" placeholder="Referee's postal address" required >
...
<?php if(ISSET($refvalue)){if($refvalue == 'Positive'){echo 'checked';}} ?> required /></td>
...
<?php if(ISSET($refvalue)){if($refvalue == 'Corrected'){echo 'checked';}} ?> required />&#93; Corrected &emsp;&emsp; 
...
<?php if(ISSET($refvalue)){if($refvalue == 'Normal'){echo 'checked';}} ?> required />&#93; Normal &emsp;&emsp; 
...
<?php if(ISSET($refvalue)){if($refvalue == 'Positive'){echo 'checked';}} ?> required />Positive
...
<p>30. Urinalysis:</br>
<textarea cols="20" rows="7" name="37" placeholder="Urinalysis details" required >
<?php  $refvalue ="37" ; include ('refvalue.php'); ?>
</textarea></p>

<p>31. Stool:</br>
<textarea cols="20" rows="7" name="38" placeholder="Stool details" required >
<?php  $refvalue ="38" ; include ('refvalue.php'); ?>
</textarea></p>

<p>32. Haemoglobin:</br>
<textarea cols="20" rows="7" name="39" placeholder="Haemoglobin details" required >
...
<p>34. Comment&#40;s&#41;:</br>
<textarea cols="20" rows="7" name="41" placeholder="Comment(s)" required >
...
35. Today the <?php echo date("d/m/Y") ; ?>, To the best of my knowledge, I comply that all the informations
...
<input type="checkbox" name="43" value="checked" required>
Signature
</div>
</fieldset>
</p>
...
<p><input type="submit" name="submit3" value="Submit" />
</form>
