...
<input type="button" value="<<< Back" onclick="location.href='interview3.php'" />
</div>
<h2 style="color:blue; float:left;">INTERVIEW MODE</h2>
<div style="float:left;">
<?php
if(ISSET($_SESSION['email'])){
echo "<input type='button' value='View candidates referees' onclick='location.href=".'"'."interview5.php".'"'."' />" ;
}?>
