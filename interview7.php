...
<input type="button" value="<<< Back" onclick="location.href='interview6.php'" />
</div>
<h2 style="color:blue; float:left;">INTERVIEW MODE</h2>
<div style="float:left;">
<?php
if(ISSET($_SESSION['email'])){
echo "<input type='button' value='Enter another candidate's admission number' onclick='location.href=".'"'."interview.php".'"'."' />" ;
}?>
</div>
</fieldset>
