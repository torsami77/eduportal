...
value="<?php  $refvalue ='31' ; include ('refvalue.php'); ?>" required
/>
</p>
...
<textarea cols="40" rows="7" name="35" placeholder="Is there any other information that you feel necessary in our consideration of this applicant?" required >
...
16. Today the <?php echo date("d/m/Y") ; ?>, To the best of my knowledge, I comply that all the informations
...
<input type="checkbox" name="36" value="checked" required>
Signature
</div>
</fieldset>
</p>
