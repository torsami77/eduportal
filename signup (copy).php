...
$_SESSION ['teller']= 777778888888;
$_SESSION ['addnum']= 2018367;
$_SESSION ['prog']= 'ctpm';
...
<?php if(file_exists($passportdir)){echo'<img src="'.$passportdir.'" />';
echo '</br><font color="green">Passport uploaded successfully...</font>
</br><input type="file" name="photo" required/></br>
<input type="submit" name="pass" value="Change Passport"/>';}
else{$photo = 'Upload a passport photograph'; include('passport.php'); };
if(isset($_POST['pass'])){
...
}else{$photo = 'Image file too small'; include('passport.php');};}else{
$photo = 'Selected file is not an image</br>Please select an image file'; include('passport.php');};}
?>
</div>
</form>
<fieldset>
