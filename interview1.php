...
echo "<input type='button' value='<<< Back' onclick='location.href=".'"'."interview01.php".'"'."' />" ;
}else{
echo "<input type='button' value='<<< Back' onclick='location.href=".'"'."interview0.php".'"'."' />" ;
}?>
</div>
<h2 style="color:blue; float:left;">INTERVIEW MODE</h2>
<div style="float:left;">
<input type="button" value=">>> Foward" onclick="location.href='interview2.php'" />
</div>
</fieldset>
...
<p>11. <select name="marital" id="<?php  $value='marital'; include ('value.php'); ?>" >
...
<div style="float:left;">
<input type="button" value="<<< Back" onclick="location.href='interview0.php'" />
</div>
<h2 style="color:blue; float:left;">INTERVIEW MODE</h2>
<div style="float:left;">
<input type="button" value=">>> Foward" onclick="location.href='interview2.php'" />
